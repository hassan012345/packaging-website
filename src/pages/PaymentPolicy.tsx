  ...
  <>
    ...
    <section className="py-16">
      <div className="container mx-auto px-4 max-w-3xl prose prose-sm">
        ...
        <p className="text-muted-foreground mb-4">
          For large or bulk custom packaging orders exceeding $2,000 in total value, Custom Packaging Lane requires a 50% deposit before production begins. The remaining 50% balance is due upon completion of production and before shipment. This deposit is non-refundable once production has commenced, as custom products are manufactured specifically to your order. Deposit invoices will be issued by our sales team with clear payment terms and due dates.
        </p>

        <h3 className="text-xl font-semibold text-foreground mb-3">Wholesale & Business Invoicing</h3>
        <p className="text-muted-foreground mb-4">
          Custom Packaging Lane offers invoicing options for established wholesale and business accounts. Qualified businesses may apply for Net 15 or Net 30 payment terms based on order volume and account history. To set up a wholesale account or inquire about business invoicing, please contact our sales team at support@custompackaginglane.com. All wholesale invoices must be paid within the agreed-upon terms. Late payments may incur a 1.5% monthly interest charge on the outstanding balance and may result in suspension of credit terms.
        </p>

        <h3 className="text-xl font-semibold text-foreground mb-3">Currency & Pricing</h3>
        <p className="text-muted-foreground mb-4">
          All prices displayed on the Custom Packaging Lane website are listed in United States Dollars (USD). Prices are subject to change without prior notice, but any price changes will not affect orders that have already been confirmed and paid for. Quoted prices are valid for 30 days from the date of the quote unless otherwise specified. For international customers, your bank or payment provider may apply currency conversion fees, which are the responsibility of the customer.
        </p>

        <h3 className="text-xl font-semibold text-foreground mb-3">Sales Tax</h3>
        <p className="text-muted-foreground mb-4">
          Custom Packaging Lane collects sales tax in states where we are required to do so by law. Applicable sales tax will be calculated and displayed at checkout based on your shipping address. If you are a tax-exempt organization, please provide a valid tax exemption certificate before placing your order by emailing it to support@custompackaginglane.com. Tax-exempt status will be applied to your account once your certificate has been verified.
        </p>

        <h3 className="text-xl font-semibold text-foreground mb-3">Payment Security</h3>
        <p className="text-muted-foreground mb-4">
          Your payment security is our top priority. All payment transactions on our website are processed through PCI-DSS compliant payment gateways with 256-bit SSL encryption. We do not store your full credit card information on our servers. Payment data is handled entirely by our secure third-party payment processors. If you have any concerns about payment security, please contact us at support@custompackaginglane.com or call +1 (970) 794-3622.
        </p>

        <h3 className="text-xl font-semibold text-foreground mb-3">Contact Us</h3>
        <p className="text-muted-foreground mb-4">
          For questions about payments, billing, invoicing, or account setup, please contact our team at support@custompackaginglane.com or call +1 (970) 794-3622. Our billing department is available Monday through Friday, 9:00 AM to 6:00 PM EST.
        </p>
      </div>
    </section>
  </>
