  ...
  <>
    ...
    <section className="py-16">
      <div className="container mx-auto px-4 max-w-3xl prose prose-sm">
        ...
        <p className="text-muted-foreground mb-4">
          All custom packaging products are made-to-order based on your approved artwork and specifications. Once production has begun, orders are considered final and are non-refundable. This includes all custom-printed boxes, mailer boxes, retail packaging, display boxes, and any other product manufactured to your design. We strongly encourage all customers to carefully review their artwork proofs and specifications before granting production approval.
        </p>
        ...
        <p className="text-muted-foreground mb-4">
          Approved refunds will be processed within 7-10 business days from the date of approval. Refunds will be issued to the original payment method used at the time of purchase. Please note that your bank or credit card company may take an additional 3-5 business days to post the refund to your account. For payments made via bank transfer, refunds will be returned to the originating bank account and may take up to 15 business days to process fully.
        </p>
        ...
        <p className="text-muted-foreground mb-4">
          If you need to modify your order after it has been placed but before production has started, please contact us immediately. We will do our best to accommodate changes to quantities, dimensions, or artwork. Modifications requested after production has begun may not be possible and could result in additional charges. Any approved modifications may also affect your estimated delivery date.
        </p>
